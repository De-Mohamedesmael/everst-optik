                        ...
                        <div class="row  @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-group">
                                    ...
                                    {!! Form::file('image', ['class' => 'form-control modal-input app()->isLocale("ar")
                                    ? text-end : text-start']) !!}
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                    ...
                                    <div class="col-md-12">
                                        <table class="table table-borderless" id="important_date_table">
                                            ...
                                            <tbody>
                                                ...
                                                @include('customer::back-end.customers.partial.important_date_row', [
                                                'index' => $loop->index,
...
<script type="text/javascript">
    ...
    $('#customer_type_id').on('change', function() {
        ...
        $(document).on('click', '.add_date', function() {
            ...
            $.ajax({
                method: 'GET',
                url: '/dashboard/customers//get-important-date-row',
                data: {
                    index: index
                },
