                            ...
                            <div class="row">
                                ...
                                <div class="card mb-0 pb-2 py-2 flex-row d-flex flex-wrap justify-content-between align-items-center"
                                   ...
                                   ">
                                            ...
                                            {!! Form::select(
                                              ...
                                              !empty($transaction->received_currency_id) ? $transaction->received_currency_id : Modules\Setting\Entities\System::getProperty('currency'),
                                              ['class' => ' selectpicker', 'data-live-search' => 'true'],
                                              ) !!}
                                        </div>
                                    </div>
                                ...
                                <div style="border-radius: 8px;width: 100%"
                                    ...
                                    <div class="col-12 d-flex flex-column flex-lg-row">
                                        ...
                                        flex-wrap: nowrap;
                                        padding-right:25px">
                                                {!! Form::select('customer_id', $customers, !empty($transaction) ? $transaction->customer_id : null, [
                                                'class' => 'selectpicker ',
                                                'data-live-search' => 'true',
                                                'style' => 'width: 80%',
                                                'id' => 'customer_id',
