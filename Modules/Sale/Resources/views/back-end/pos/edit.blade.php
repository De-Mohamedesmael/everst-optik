...
@section('title', __('lang.pos') .' | '. $transaction->invoice_no)
@section('styles')
...
<section class="forms pos-section no-print p-0">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                {!! Form::open(['url' =>route('admin.pos.update', $transaction->id), 'method' => 'PUT', 'files' => true,
                'class' => 'pos-form', 'id' => 'edit_pos_form']) !!}
                            ...
                            <div class="card mb-0 pb-2 py-2 flex-row d-flex flex-wrap justify-content-between align-items-center"
                                ...
                                <div class="col-6 col-lg-2 d-flex justify-content-center align-items-center">
                                    ...
                                    ">
                                        ...
                                        {!! Form::select('store_id', $stores, $transaction->store_id, [
                                        'class' => 'selectpicker ',
                                ...
                                <div class="col-6 col-lg-2 d-flex justify-content-center align-items-center">
                                   ...
                                   ">
                                        ...
                                        !empty($transaction->received_currency_id) ? $transaction->received_currency_id
                                        : Modules\Setting\Entities\System::getProperty('currency'),
                                        ['class' => ' selectpicker', 'data-live-search' => 'true'],
                                        ) !!}
                                    </div>
                                </div>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <span class="totals-title mr-2" style="color: #000;font-weight: 600;">{{
                                                    __('lang.items') }}</span>
                                                <span id="item" class="border px-2 py-2 rounded">0</span>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <span id="item-quantity" class="border px-2 py-2 rounded">0</span>
                                            </div>
                                        ...
                                        <div
                                            ...
                                            height: 30px;">
                                                    ...
                                                    <select name="terms_and_condition_id" id="terms_and_condition_id"
                                                        ...
                                                        <option @if ($transaction->terms_and_condition_id == $key)
                                                            selected @endif value="{{ $key }}">{{ $item }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            height: 30px;">
                                                    ...
                                                    $transaction->commissioned_employees, [
