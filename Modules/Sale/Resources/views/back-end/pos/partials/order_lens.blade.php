        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul class="nav nav-tabs mb-2 @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif"
                    role="tablist">
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link  active " href="#create" role="tab"--}}
{{--                            data-toggle="tab">{{translate('create_lens')}}</a>--}}
{{--                    </li>--}}
                    <li class="nav-item">
                        <a class="nav-link active" href="#preview_lens" role="tab"
                            data-toggle="tab">{{translate('preview_lens')}}</a>
                    </li>
...
{{--                    </div>--}}
                    ...
                    <div role="tabpanel" class="tab-pane fade  show active " id="preview_lens">
