<div class="modal-dialog" role="document">
    <div class="modal-content">
        {!! Form::open(['url' => route('admin.index_lenses.update',$index_lens->id), 'id'=>'form-index_lens','method' => 'put']) !!}

        <div
            class="modal-header position-relative border-0 d-flex justify-content-between align-items-center @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">

            <h4 class="modal-title px-2 position-relative">@lang('lang.add_index_lens')
            ...
            <div
                ...
                <div
                    ...
                    <input type="text" required style="width: 100%"
                           ...
                           placeholder="@lang('lang.name')" name="name" value="{{ old('name',$index_lens->name) }}" >
                    @error('name')
