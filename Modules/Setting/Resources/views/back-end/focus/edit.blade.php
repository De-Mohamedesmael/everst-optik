<div class="modal-dialog" role="document">
    <div class="modal-content">
        {!! Form::open(['url' => route('admin.foci.update',$focus->id), 'id'=>'form-focus','method' => 'put']) !!}
        ...
        <div
            ...
            <div class="col-md-6 px-5">
                <div
                    class="mb-2 align-items-center form-group @if (app()->isLocale('ar')) flex-row-reverse mr-3 @else ml-3 @endif">
                    ...
                    <div
                        ...
                        <input type="text" required style="width: 100%"
                               ...
                               placeholder="@lang('lang.name')" name="name" value="{{ old('name',$focus->name) }}" >
                        @error('name')
            ...
            <div class="col-md-6 px-5">
                <div class="form-group">
                    {!! Form::label('design_id', __('lang.designs'), [
                        'class' => 'form-label d-block mb-1 ',
                    ]) !!}
                    {!! Form::select('design_id[]', $designs,$design->designs()->pluck('designs.id'), [
