<div class="modal-dialog" role="document">
    <div class="modal-content">
        {!! Form::open(['url' => route('admin.designs.update',$design->id), 'id'=>'form-design','method' => 'put']) !!}
            ...
            <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <input type="text" required style="width: 100%"
                                   ...
                                   placeholder="@lang('lang.name')" name="name" value="{{ old('name',$design->name) }}" >
                            @error('name')
                ...
                <div class="col-md-6 px-5">
                    <div class="form-group">
                        ...
                        {!! Form::select('focus_id[]', $foci,$design->foci()->pluck('foci.id'), [
