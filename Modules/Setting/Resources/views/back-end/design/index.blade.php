...
<li class="breadcrumb-item  @if (app()->isLocale('ar')) mr-2 @else ml-2 @endif active" aria-current="page">
    @lang('lang.designs')</li>
@endsection

@section('button')

@can('settings.design.create_and_edit')
<div class="widgetbar d-flex @if (app()->isLocale('ar')) justify-content-start @else justify-content-end @endif">
    <a style="color: white" data-href="{{ route('admin.designs.create') }}" data-container=".view_modal"
        class="btn btn-modal btn-main"><i class="dripicons-plus"></i>
        {{translate('add_design')}}
    </a>
</div>
@endcan
@endsection
                    ...
                    <div class="card-body">
                        <table class="table dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="col1">{{$design->name}}</td>
                                    <td class="col6">
                                        @can('settings.design.create_and_edit')
                                        <a data-href="{{ route('admin.designs.edit', $design->id) }}"
                                            data-container=".view_modal" class="btn btn-primary btn-modal  edit_job">
                                            <i class="fa fa-pencil-square-o"></i>
                                        </a>
                                        @endcan
                                        @can('settings.design.delete')
                                        <a data-href="{{ route('admin.designs.destroy', $design->id) }}"
