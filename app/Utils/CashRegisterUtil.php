...
class CashRegisterUtil extends Util
{
    ...
    public function countOpenedRegister(): int
    {
        ...
        return CashRegister::where('admin_id', $admin_id)
            ->where('status', 'open')
            ->count();
    }
     ...
     * @return object|null
     */
    public function getCurrentCashRegister($admin_id): object|null
    {
        return CashRegister::where('admin_id', $admin_id)
            ->where('status', 'open')
            ->first();
     ...
     * @return object
     */
    public function getCurrentCashRegisterOrCreate($admin_id): object
    {
     ...
     * @param string $type
     * @param null $admin_id
     * @param null $transaction_payment_id
     * @return boolean
     */
    public function addPayments($transaction, $payment, string $type = 'credit', $admin_id = null, $transaction_payment_id = null): bool
    {
        if (empty($admin_id)) {
     ...
     * @return boolean
     */
    public function updateAddStockAndExpensePayments($transaction, $payment_data, $request): bool
    {
        $admin_id = null;
     ...
     * Adds sell payments to currently opened cash register
     *
     * @param object $transaction /int $transaction
     * @param array $payments
     *
     * @return boolean
     */
    public function updateSellPaymentsBasedOnPaymentDate(object $transaction, array $payments): bool
    {
     ...
     * @return boolean
     */
    public function updateSellPayments(object $transaction, array $payments): bool
    {
        $admin_id = auth()->user()->id;
        $transaction = Transaction::find($transaction->id);
